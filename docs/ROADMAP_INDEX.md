...
- [INVALIDATION_AND_RECOMPUTE_RULES.md](./INVALIDATION_AND_RECOMPUTE_RULES.md)
...
- [MLT_BACKEND_INTEGRATION_PLAN.md](./MLT_BACKEND_INTEGRATION_PLAN.md)
...
- 与专业剪辑器的关键差距
- 对标达芬奇的能力差距表与建议执行顺序
- 对标达芬奇路线的 P0 任务拆分与建议批次
- 时间线内核 V1 的结构定义与迁移边界
- 局部失效、重编译、缓存复用与 preview/final 边界定义
- 三阶段成熟路线
- 现有底层渲染引擎的结构性短板
- 是否需要换后端的决策门槛
...
- [TELEMETRY_PRIVACY_AND_SUPPORT_GUIDE.md](./TELEMETRY_PRIVACY_AND_SUPPORT_GUIDE.md)
...
2. [DAVINCI_BENCHMARK_GAP_AND_EXECUTION_ROADMAP.md](./DAVINCI_BENCHMARK_GAP_AND_EXECUTION_ROADMAP.md)
3. [DAVINCI_P0_EXECUTION_TASKLIST.md](./DAVINCI_P0_EXECUTION_TASKLIST.md)
4. [COMMERCIAL_PRODUCT_MATURITY_PLAN.md](./COMMERCIAL_PRODUCT_MATURITY_PLAN.md)
5. [RENDER_ENGINE_STRUCTURAL_ISSUES_AND_BACKEND_DECISION.md](./RENDER_ENGINE_STRUCTURAL_ISSUES_AND_BACKEND_DECISION.md)
6. [MULTI_BACKEND_RENDER_ARCHITECTURE_PLAN.md](./MULTI_BACKEND_RENDER_ARCHITECTURE_PLAN.md)
7. [RENDER_PERFORMANCE_LOW_RISK_ACCELERATION_PLAN.md](./RENDER_PERFORMANCE_LOW_RISK_ACCELERATION_PLAN.md)
8. [PYTHON_WORKER_PACKAGING.md](./PYTHON_WORKER_PACKAGING.md)
9. [TEMPLATE_MATCHING_BGM_AND_TIMELINE_EXECUTION_PLAN.md](./TEMPLATE_MATCHING_BGM_AND_TIMELINE_EXECUTION_PLAN.md)

这条线的目标是先回答：

- 这个项目先做成什么最有胜算
- 如果希望未来更接近达芬奇，哪条路线才不至于做成“假成熟”
- 要达到成熟商业产品还差哪些关键能力
- 现有引擎还值不值得继续深挖
